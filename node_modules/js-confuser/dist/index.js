...
function _obfuscate() {
  _obfuscate = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(sourceCode, options) {
    var obfuscator;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          obfuscator = new _obfuscator["default"](options);
          return _context.abrupt("return", obfuscator.obfuscate(sourceCode));
        case 2:
        case "end":
...
function _obfuscateAST() {
  _obfuscateAST = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ast, options) {
    var obfuscator;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          obfuscator = new _obfuscator["default"](options);
          return _context2.abrupt("return", obfuscator.obfuscateAST(ast));
        case 2:
        case "end":
